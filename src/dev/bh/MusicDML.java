...
public class MusicDML {
    public static void main(String[] args) {
        try (Connection connection = DriverManager.getConnection(
                "jdbc:mysql://localhost:3306/music?continueBatchOnError",
           ...
           if (!executeSelect(statement, tableName, columnName, columnValue)) {
               ...
               /*updateRecord(statement, tableName, columnName, columnValue, columnName,
    ...
    private static boolean deleteRecord(Statement statement, String table, String columnName,
                                        String columnValue) throws SQLException{
    ...
    private static boolean updateRecord(Statement statement, String table,
                                        ...
                                        String updateColumn, String updatedValue)
            throws SQLException{
    ...
    private static void insertArtistAlbum(Statement statement, String artistName, String albumName)
        ...
        for (int i = 0; i< songs.length; i++) {
            String songQuery = songInsert.formatted(i + 1, statement.enquoteLiteral(songs[i]),
                    albumId);
